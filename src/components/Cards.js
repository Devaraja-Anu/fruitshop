        ...
        <div className=" border-2 rounded-3xl ">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="w-full flex justify-between pr-4 py-2 bg-white">
              <h1 className="text-2xl pl-2">
                {details.fruit ?? "Oops! fruit not loaded"}
              </h1>
          ...
          <button
            className={` text-white ${
              details.Background ?? defaultBackground
            } w-full text-2xl h-16 rounded-b-3xl hover:text-3xl transition-all`}
          >
            Add to Cart
          </button>
        </div>
